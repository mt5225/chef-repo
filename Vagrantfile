...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mt5225-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mt5225"
  #   chef.validation_client_name = "mt5225-validator"
  #   chef.validation_key_path = ".chef/mt5225-validator.pem"
  # end
end
